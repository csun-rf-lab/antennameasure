...
classdef planBidirectionalRunTest < matlab.unittest.TestCase
    methods(Test)
        ...
        function twoAxes(testCase)
            ...
            job.axes(3).enable = "Off";
            expected = [0 45; 0 60; 0 75; 0 90; 10 90; 10 75; 10 60; 10 45; 20 45; 20 60; 20 75; 20 90];
            actual = planBidirectionalRun(job);
            testCase.verifyEqual(actual, expected)
        end
        ...
        function threeAxes(testCase)
            ...
            expected = [0 60 10; 0 60 20; 0 70 20; 0 70 10; 10 70 10; 10 70 20; 10 60 20; 10 60 10];
            actual = planBidirectionalRun(job);
            testCase.verifyEqual(actual, expected)
        end
