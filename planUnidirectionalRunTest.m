...
classdef planUnidirectionalRunTest < matlab.unittest.TestCase
    methods(Test)
        function oneAxis(testCase)
            ...
            [actualAxes, actualPositions] = planUnidirectionalRun(job);
        ...
        function twoAxes(testCase)
            ...
            job.axes(3).enable = "Off";
            expectedAxes = [2 1];
            expectedPositions = [45 0; 45 10; 45 20; 60 0; 60 10; 60 20; 75 0; 75 10; 75 20; 90 0; 90 10; 90 20];
            [actualAxes, actualPositions] = planUnidirectionalRun(job);
            testCase.verifyEqual(actualAxes, expectedAxes)
            testCase.verifyEqual(actualPositions, expectedPositions)
        end
        ...
        function threeAxes(testCase)
            ...
            expectedAxes = [3 2 1];
            expectedPositions = [10 60 0; 10 60 10; 10 70 0; 10 70 10; 20 60 0; 20 60 10; 20 70 0; 20 70 10];
            [actualAxes, actualPositions] = planUnidirectionalRun(job);
            testCase.verifyEqual(actualAxes, expectedAxes)
            testCase.verifyEqual(actualPositions, expectedPositions)
        end
